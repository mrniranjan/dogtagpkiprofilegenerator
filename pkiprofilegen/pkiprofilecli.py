import argparse
import pkiprofilegen.pkiprofilelib as pkiprofilelib
...
def main():
    ...
    parser.add_argument('--rangeunit', type=str, help="Units in days,minutes,months,year")
...
def Generate_Profile_hash(args):
    ...
    if args.rangeunit:
        rangeunit = args.rangeunit
        Profile_Input_Dict['rangeunit'] = args.rangeunit
    else:
        Profile_Input_Dict['rangeunit'] = 'days'
...
def profile_dualcert_input_parser(args):
    ...
    rangeunit = Profile_Input_Dict1['rangeunit']
...
def New_Edit_Profile(args):
    ...
    if args.maxvalidity and args.validfor and args.rangeunit and args.rangeunit:
        pkiprofilelib.Validity_Default(root_element,PolicySet, args.validfor, args.maxvalidity, args.rangeunit)    
...
def Add_Policies(root_element, PolicySet, Profile_Input_Dict):
    ...
    if not (Profile_Input_Dict.has_key('PathLength') and Profile_Input_Dict.has_key('isCA')):
        ...
        pkiprofilelib.Validity_Default(root_element,PolicySet, Profile_Input_Dict['Validity'],Profile_Input_Dict['MaxValidity'], Profile_Input_Dict['rangeunit'])
